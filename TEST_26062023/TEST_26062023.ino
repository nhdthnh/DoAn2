...
const int wifiConnectInterval = 10000;  // 10 giây
BlynkTimer timer;
WiFiManager wifiManager;
Button2 resetButton(bt);
byte customChar[] = { B00100, B01010, B00100, B00000, B00000, B00000, B00000, B00000 };
void setup() {
  lcd.init();
  lcd.backlight();
  dht.begin();
...
void loop() {
  ...
  resetButton.loop(); // Cập nhật trạng thái nút reset (nếu có)
}
